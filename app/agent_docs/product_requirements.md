...
- Downloadable claim summary - a "Download claim summary" button on the preview screen saves a plain-text copy (`src/lib/claimSummary.ts`, native `Blob` + `<a download>`, no PDF library added).
